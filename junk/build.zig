...
pub fn build(b: *std.Build) !void {
    ...
    const exe = b.addExecutable(.{
        .name = /home/nil/zig/kickzig/junk,
        .root_source_file = .{ .path = "/home/nil/zig/kickzig/junk.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    const compile_step = b.step("/home/nil/zig/kickzig/junk", "Compile /home/nil/zig/kickzig/junk");
    ...
    const run_step = b.step("run-/home/nil/zig/kickzig/junk", "Run /home/nil/zig/kickzig/junk");
