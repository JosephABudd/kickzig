...
const line_start =
    ...
    \\/// 1. Any front-end messenger can send a "{0s}" message to the subscribed back-end messengers.
    \\/// 2. Every subscribed back-end messenger receives a copy of each "{0s}" message sent from the front-end.
    \\
;
...
const line_end =
    ...
    \\/// .receiveFn receives a {0s} message from the back-end.
