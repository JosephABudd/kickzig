...
;
// \\
// \\    panels.home = try home_panel.init(allocator, main_view, panels, messenger, exit, window);
// \\    errdefer {
// \\        panels.deinit();
// \\    }
// \\    panels.other = try other_panel.init(allocator, main_view, panels, messenger, exit, window);
// \\    errdefer {
// \\        panels.deinit();
// \\    }
