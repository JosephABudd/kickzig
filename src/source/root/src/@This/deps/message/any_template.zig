...
pub const Template = struct {
    ...
    pub fn content(self: *Template) ![]const u8 {
        ...
        var replacement_size: usize = try std.mem.replacementSize(u8, self.allocator, template, "{{copy}}", copy);
...
const template =
    ...
    \\/// This file will be removed by kickzig if you remove the "{{copy}}" message.
    \\const std = @import("std");
    \\
    \\/// This is the "{{copy}}" message.
