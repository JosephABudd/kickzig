...
const line_start =
    ...
    \\/// 1. Any back-end messenger can send a "{{ channel_name }}" message to the subscribed front-end messengers.
    \\/// 2. Every subscribed front-end messenger receives a copy of each "{{ channel_name }}" message sent from the back-end.
    \\
;
